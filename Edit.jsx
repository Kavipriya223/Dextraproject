...
const Edit = () => {
  return (
    <div>
      ...
      <p className='  text-xl mt-1.5'><Link to='/map'><FaArrowLeft /></Link></p>
    ...
    <input type="text" placeholder='Nandhu' className='shadow-lg text-xl w-full mt-2 placeholder:text-black max-sm:text-lg'/>
    <div className='flex mt-2'>
    <button className='bg-gray-300 w-20 h-10 rounded-lg '>Cancel</button>
    <button className='bg-orange-400 w-20 h-10 rounded-lg ml-4'>Update</button>
    </div>
    </div>
